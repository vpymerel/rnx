  ...
  mutate(
    categ=
      ifelse(cs=="scaffold_1" && start < 127000000, "X0",
             ifelse(cs=="scaffold_1" && start >= 127000000 && start < 140250000, "XYa",
                    ifelse(cs=="scaffold_1" && start >= 140250000 && start < 157000000, "XYb",
                    #ifelse(cs=="scaffold_1" && start >= 144000000 && start < 157000000, "XYc",
...
TE_df$categ=factor(TE_df$categ, levels=c("X0","XYa","XYb","PAR","Auto")) #XYc
...
wilcox.test(TE_df$Per[TE_df$categ=="X0"], TE_df$Per[TE_df$categ=="PAR"])


wilcox.test(TE_df$Per[TE_df$categ=="XYa"], TE_df$Per[TE_df$categ=="Auto"])
wilcox.test(TE_df$Per[TE_df$categ=="XYa"], TE_df$Per[TE_df$categ=="PAR"])
median(TE_df$Per[TE_df$categ=="XYa"])


wilcox.test(TE_df$Per[TE_df$categ=="XYb"], TE_df$Per[TE_df$categ=="Auto"])
wilcox.test(TE_df$Per[TE_df$categ=="XYc"], TE_df$Per[TE_df$categ=="Auto"])
median(TE_df$Per[TE_df$categ=="XYc"])
